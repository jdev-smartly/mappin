...
export const AnimatedPinListItem: React.FC<AnimatedPinListItemProps> = ({
  ...
  return (
    ...
    >
      <motion.div
        className="h-[86px] flex items-center gap-3 hover:bg-gray-50 transition-colors p-3"
      ...
      >
        {/* Avatar */}
        <motion.div 
          className="w-[38px] h-[38px] border rounded-full flex-none flex items-center justify-center bg-[#E9E9EB]/60"
